...
@EnableJpaRepositories(
    ...
    entityManagerFactoryRef = MysqlDataSourceConfig.DATABASE_NAME + "EntityManagerFactory",
    transactionManagerRef = MysqlDataSourceConfig.DATABASE_NAME + "TransactionManager"
)
class MysqlDataSourceConfig(
    ...
    companion object {
        const val DATABASE_NAME = "mysql"
    }

    @Value("\${spring.datasource.mysql.dialect}")
    ...
    @ConfigurationProperties(prefix = "spring.datasource.mysql.main")
    fun writeDataSource(): DataSource {
        return HikariDataSource()
    }

    @Bean(name = [DATABASE_NAME + "ReadonlyDataSource"])
    @ConfigurationProperties(prefix = "spring.datasource.mysql.readonly")
    ...
    fun entityManagerFactory(
        ...
        val emfb = builder.dataSource(dataSource)
            ...
            .packages("com.example.multidatasourceexample.domain.mysql")
            .build()
